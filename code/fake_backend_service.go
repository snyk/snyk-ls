...
func (f *FakeBackendService) CreateBundle(files map[lsp.DocumentURI]structs.File) (string, []lsp.DocumentURI, error) {
...
func (f *FakeBackendService) ExtendBundle(bundleHash string, files map[lsp.DocumentURI]structs.File, removedFiles []lsp.DocumentURI) ([]lsp.DocumentURI, error) {
