...
func TestFolderConfig_ToLspFolderConfig(t *testing.T) {
	...
	t.Run("copies folder-scope settings via resolver and configuration", func(t *testing.T) {
		...
		require.NotNil(t, result.Settings[types.SettingSeverityFilterHigh])
		assert.Equal(t, true, result.Settings[types.SettingSeverityFilterHigh].Value)
		require.NotNil(t, result.Settings[types.SettingSeverityFilterMedium])
		assert.Equal(t, true, result.Settings[types.SettingSeverityFilterMedium].Value)
		require.NotNil(t, result.Settings[types.SettingSeverityFilterLow])
		assert.Equal(t, true, result.Settings[types.SettingSeverityFilterLow].Value)
