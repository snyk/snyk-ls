...
// Package snyk is a generated GoMock package.
package snyk
...
func (m *MockIssueProvider) Issues() IssuesByFile {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Issues")
	ret0, _ := ret[0].(IssuesByFile)
	return ret0
}
...
// Issues mocks base method.
func (m *MockCacheProvider) Issues() IssuesByFile {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Issues")
	ret0, _ := ret[0].(IssuesByFile)
	return ret0
...
func (m *MockFilteringIssueProvider) FilterIssues(issues IssuesByFile, supportedIssueTypes map[product.FilterableIssueType]bool) IssuesByFile {
	m.ctrl.T.Helper()
...
// Issues mocks base method.
func (m *MockFilteringIssueProvider) Issues() IssuesByFile {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Issues")
	ret0, _ := ret[0].(IssuesByFile)
	return ret0
