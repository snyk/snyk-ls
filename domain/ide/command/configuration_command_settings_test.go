...
func TestConstructSettingsFromConfig_AllFieldsPopulated(t *testing.T) {
	...
	t.Run("Folder Configs", func(t *testing.T) {
		...
		require.NotNil(t, settings.StoredFolderConfigs, "FolderConfigs should be initialized")
	})
}
...
func TestConstructSettingsFromConfig_StoredFolderConfigs(t *testing.T) {
	...
	settings := constructSettingsFromConfig(c, nil)
	require.NotNil(t, settings.StoredFolderConfigs, "FolderConfigs should be initialized")
	assert.Empty(t, settings.StoredFolderConfigs, "FolderConfigs should be empty when no workspace is set")
}
