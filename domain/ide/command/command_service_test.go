...
func Test_ExecuteCommand(t *testing.T) {
	...
	service := NewService(engine, engine.GetLogger(), authenticationService, nil, nil, nil, nil, nil, nil, NewLdxSyncService(resolver), nil, nil, nil, t.Context())
...
func Test_ExecuteCommand_CanceledCommand_ReturnsCancellationWithoutError(t *testing.T) {
	...
	service := NewService(engine, engine.GetLogger(), authService, featureflag.NewFakeService(), notifier, nil, nil, nil, nil, mock_command.NewMockLdxSyncService(ctrl), resolver, nil, nil, nil)
