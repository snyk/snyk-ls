...
// trusted before it is scanned. It mirrors the message of the legacy
// window/showMessageRequest trust dialog (command.GetTrustMessage) so the
// in-tree banner and the modal stay consistent. (IDE-1882)
