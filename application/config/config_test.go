...
func TestConfigDefaults(t *testing.T) {
	...
	assert.True(t, c.FilterCriticalSeverity(), "Error Critical severity should be enabled by default")
	assert.True(t, c.FilterHighSeverity(), "Error High severity should be enabled by default")
	assert.True(t, c.FilterMediumSeverity(), "Error Medium severity should be enabled by default")
	assert.True(t, c.FilterLowSeverity(), "Error Low severity should be enabled by default")
