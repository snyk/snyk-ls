...
func TestConfigDefaults(t *testing.T) {
	...
	assert.True(t, c.SeverityFilter()["critical"], "Error Critical severity should be enabled by default")
	assert.True(t, c.SeverityFilter()["high"], "Error High severity should be enabled by default")
	assert.True(t, c.SeverityFilter()["medium"], "Error Medium severity should be enabled by default")
	assert.True(t, c.SeverityFilter()["low"], "Error Low severity should be enabled by default")
