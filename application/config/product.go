...
func (c *Config) IsProductEnabledForFolder(p product.Product, folderConfig types.ImmutableFolderConfig) bool {
	switch p {
...
// considering LDX-Sync org config and user overrides.
func (c *Config) DisplayableIssueTypesForFolder(folderConfig types.ImmutableFolderConfig) map[product.FilterableIssueType]bool {
