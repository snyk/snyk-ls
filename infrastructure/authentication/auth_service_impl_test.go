...
func TestAuthenticateSendsAuthenticationEventOnSuccess(t *testing.T) {
	...
	service := NewAuthenticationService(c.Engine(), c.TokenService(), provider, error_reporting.NewTestErrorReporter(c), notification.NewMockNotifier())
...
func Test_AuthURL(t *testing.T) {
	...
	service := NewAuthenticationService(c.Engine(), c.TokenService(), provider, error_reporting.NewTestErrorReporter(c), notification.NewNotifier())
...
func Test_UpdateCredentials(t *testing.T) {
	t.Run("CLI Authentication", func(t *testing.T) {
		c := testutil.UnitTest(t)
		service := NewAuthenticationService(c.Engine(), c.TokenService(), nil, error_reporting.NewTestErrorReporter(c), notification.NewNotifier())
	...
	t.Run("Send notification with no URL", func(t *testing.T) {
		...
		service := NewAuthenticationService(c.Engine(), c.TokenService(), nil, error_reporting.NewTestErrorReporter(c), mockNotifier)
...
func Test_Logout(t *testing.T) {
	...
	service := NewAuthenticationService(c.Engine(), c.TokenService(), &provider, error_reporting.NewTestErrorReporter(c), notifier)
...
func TestHandleInvalidCredentials(t *testing.T) {
	t.Run("should send request to client", func(t *testing.T) {
		...
		cut := NewAuthenticationService(c.Engine(), c.TokenService(), provider, errorReporter, notifier).(*AuthenticationServiceImpl)
		mu := sync.RWMutex{}
