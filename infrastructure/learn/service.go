...
//go:generate go tool github.com/golang/mock/mockgen -source=service.go -destination=mock_learn/service_mock.go -package=mock_learn -imports=learn=github.com/snyk/snyk-ls/infrastructure/learn
