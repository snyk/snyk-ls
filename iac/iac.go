...
func retrieveAnalysis(uri sglsp.DocumentURI, scanResult iacScanResult, dChan chan lsp.DiagnosticResult, clChan chan lsp.CodeLensResult, diagnosticsError error) {
